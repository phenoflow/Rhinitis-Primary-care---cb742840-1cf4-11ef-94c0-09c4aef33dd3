...
(async () => {
  ...
  await fs.writeFile("rhinitis-primary-care-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("rhinitis-primary-care-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
